...
echo "3) Deploy MetalLB Service Saperately"
echo "4) Remove MetalLB Service From Cluster"
echo "5) Remove Kubernetes Cluster"
echo "6) Exit"
...
EOF
    ...
    sudo kubectl delete ns metallb-system
    ...
    echo "You chose to exit the script. Exiting..."
    exit 0

else
    echo "Invalid choice. Please run the script again and choose either 1,2,3,4,5 or 6."
    exit 1
fi
